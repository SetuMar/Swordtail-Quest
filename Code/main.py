...
pygame.display.set_icon(pygame.image.load(pl.Path("Graphics/transitions/window_icon.png")))
# set icon

pygame.display.set_caption("Swordtail Quest")
# update the caption
...
def load_bg():
    if game_level_handler.level_number < 3:
        path = pl.Path("Graphics/backgrounds/forest_background.png")

    if 2 < game_level_handler.level_number < 5:
        path = pl.Path("Graphics/backgrounds/pirate_bay_background.png")

    if 4 < game_level_handler.level_number < 7:
        path = pl.Path("Graphics/backgrounds/volcano_background.png")

    if 6 < game_level_handler.level_number:
        path = pl.Path("Graphics/backgrounds/ice_background.png")
...
# Load Title Screen
title_path = pl.Path("Graphics/transitions/title_screen.png")
    ...
    if keyboard.is_pressed("space"):
        ...
        while True:
            ...
            # if the player health is completed
                ...
                restart_path = pl.Path("Graphics/transitions/restart.png")
                restart_screen = pygame.transform.scale(pygame.image.load(restart_path), (SCREEN_WIDTH, SCREEN_HEIGHT))

                level_cleared_path = pl.Path("Graphics/transitions/level_cleared.png")
                level_cleared_screen = pygame.transform.scale(pygame.image.load(level_cleared_path), (SCREEN_WIDTH, SCREEN_HEIGHT))
                ...
                if game_level_handler.current_level_completed and game_level_handler.level_number < 9:
                    ...
                    pygame.mixer.music.stop()
                    credit_path = pl.Path("Graphics/transitions/credit_screen.png")
                    credit_screen = pygame.transform.scale(pygame.image.load(credit_path), (SCREEN_WIDTH, SCREEN_HEIGHT))
